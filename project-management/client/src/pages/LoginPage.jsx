  ...
  return (
    <div className="flex justify-center items-center min-h-[80vh]">
      <div className="bg-white dark:bg-slate-800 p-8 rounded-xl w-full max-w-md shadow-xl border border-slate-200 dark:border-slate-700 transition-colors duration-200">
        <h2 className="text-3xl font-bold mb-6 text-center text-slate-900 dark:text-white transition-colors">Welcome Back</h2>
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full p-3 rounded-lg bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-700 text-slate-900 dark:text-white focus:outline-none focus:border-emerald-500 dark:focus:border-emerald-500 transition-colors"
              required
            />
          </div>
          <div>
        ...
        <p className="mt-6 text-center text-slate-600 dark:text-slate-400 transition-colors">
          ...
          <Link to="/register" className="text-emerald-600 hover:text-emerald-500 dark:text-emerald-400 dark:hover:text-emerald-300 transition">
            Sign up
          </Link>
        </p>
      </div>
